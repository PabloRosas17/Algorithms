 ...
 * @return: void
 *
 * @name: increase_key(int i,int key)
 * @params: i as the index, key as the new element.
 * @description: "increase the value of element x’s key to a new value k."
 * @return: void
 *
 * @name: max_heapify(int i)
 * @params: i as the index.
